...
const SEED = [
  ...
  { name: "千层肚", emoji: "🫕", category: "火锅", description: "层层脆爽，越嚼越香", isAvailable: true, cookTime: 10 },
  { name: "肥牛", emoji: "🥩", category: "火锅", description: "薄切大片，入口即化", isAvailable: true, cookTime: 5 },
  { name: "羊肉卷", emoji: "🐑", category: "火锅", description: "鲜嫩不膻，冬日必点", isAvailable: true, cookTime: 5 },
  { name: "鸭肠", emoji: "🦆", category: "火锅", description: "清脆爽口，Q弹有劲", isAvailable: true, cookTime: 8 },
  { name: "黄喉", emoji: "🐄", category: "火锅", description: "雪白脆嫩，嚼劲十足", isAvailable: true, cookTime: 8 },
  { name: "郡肝", emoji: "🫁", category: "火锅", description: "切花入味，一口一个", isAvailable: true, cookTime: 8 },
  { name: "鱿鱼", emoji: "🦑", category: "火锅", description: "鲜嫩爽滑，Q弹可口", isAvailable: true, cookTime: 8 },
  { name: "鳕鱼", emoji: "🐟", category: "火锅", description: "细嫩鲜美，入口即化", isAvailable: true, cookTime: 5 },
  { name: "牛蛙", emoji: "🐸", category: "火锅", description: "肉质细腻，鲜嫩弹牙", isAvailable: true, cookTime: 12 },
  { name: "墨鱼仔", emoji: "🐙", category: "火锅", description: "小巧玲珑，一口一个", isAvailable: true, cookTime: 8 },
  { name: "吊龙", emoji: "🥩", category: "火锅", description: "鲜切牛肉，嫩滑多汁", isAvailable: true, cookTime: 5 },
  { name: "滑肉", emoji: "🍖", category: "火锅", description: "粉嫩晶莹，滑嫩爽口", isAvailable: true, cookTime: 10 },
  { name: "虾滑", emoji: "🦐", category: "火锅", description: "虾肉满满，弹牙鲜甜", isAvailable: true, cookTime: 8 },
  { name: "火腿肠", emoji: "🌭", category: "火锅", description: "经典搭配，老少皆宜", isAvailable: true, cookTime: 3 },
  { name: "午餐肉", emoji: "🥫", category: "火锅", description: "厚切大块，满足感爆棚", isAvailable: true, cookTime: 3 },
  { name: "撒尿牛丸", emoji: "🧆", category: "火锅", description: "一口爆汁，小心烫嘴", isAvailable: true, cookTime: 8 },
  { name: "海霸王虾饺", emoji: "🥟", category: "火锅", description: "皮薄馅大，Q弹鲜美", isAvailable: true, cookTime: 8 },
  ...
  { name: "萝卜", emoji: "🥕", category: "火锅", description: "清甜多汁，解腻首选", isAvailable: true, cookTime: 10 },
  { name: "西红柿", emoji: "🍅", category: "火锅", description: "酸甜开胃，汤底必备", isAvailable: true, cookTime: 5 },
  { name: "香菜", emoji: "🌿", category: "火锅", description: "灵魂点缀，爱者自爱", isAvailable: true, cookTime: 1 },
  { name: "豆腐", emoji: "🧈", category: "火锅", description: "嫩滑细腻，吸满汤汁", isAvailable: true, cookTime: 5 },
  { name: "响铃卷", emoji: "🥐", category: "火锅", description: "三秒即熟，酥脆吸汁", isAvailable: true, cookTime: 3 },
  { name: "豆皮", emoji: "🫘", category: "火锅", description: "薄韧爽滑，豆香浓郁", isAvailable: true, cookTime: 3 },
  { name: "豌豆尖", emoji: "🌱", category: "火锅", description: "鲜嫩清爽，火锅绝配", isAvailable: true, cookTime: 2 },
  { name: "宽粉", emoji: "🍜", category: "火锅", description: "Q弹爽滑，久煮不烂", isAvailable: true, cookTime: 8 },
  { name: "金针菇", emoji: "🍄", category: "火锅", description: "细嫩爽滑，吸汁一流", isAvailable: true, cookTime: 5 },
  { name: "香菇", emoji: "🍄", category: "火锅", description: "肥厚香浓，菌香四溢", isAvailable: true, cookTime: 8 },
  ...
  { name: "冷吃兔", emoji: "🐰", category: "凉菜", description: "麻辣干香，越嚼越有味", isAvailable: true, cookTime: 5 },
  { name: "卤鸡爪", emoji: "🐔", category: "凉菜", description: "卤香入味，软糯弹牙", isAvailable: true, cookTime: 5 },
  ...
  { name: "芬达", emoji: "🍊", category: "酒水", description: "橙味汽水，经典之选", isAvailable: true, cookTime: 0 },
  { name: "大窑", emoji: "🍾", category: "酒水", description: "国货汽水，气足味浓", isAvailable: true, cookTime: 0 },
  { name: "蜜雪", emoji: "🍹", category: "酒水", description: "甜蜜清爽，性价比之王", isAvailable: true, cookTime: 0 },
  ...
  { name: "红酒", emoji: "🍷", category: "酒水", description: "醇香浓郁，小酌怡情", isAvailable: true, cookTime: 0 },
  ...
  { name: "哈密瓜", emoji: "🍈", category: "水果", description: "甜蜜清脆，果香浓郁", isAvailable: true, cookTime: 0 },
];
